          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="mb-12 font-heading flex flex-col items-center gap-4">
              <div className="relative animate-in slide-in-from-top-10 duration-700">
                <div className="px-8 py-3 bg-white text-red-700 inline-block shadow-hero">
                  <span className="text-6xl md:text-7xl xl:text-8xl leading-none" style={{fontWeight: 900, letterSpacing: '2px'}}>IOTRIX</span>
                </div>
                <div className="absolute -inset-2 bg-gradient-to-r from-red-500/20 via-white/0 to-red-500/20 blur-2xl -z-10 rounded"></div>
              </div>
              <h2 className="text-4xl md:text-5xl xl:text-6xl font-extrabold text-white tracking-wider leading-tight animate-in fade-in-0 duration-1000 delay-150">
                IOTRIX SYMPOSIUM 2024
              </h2>
            </div>
            ...
            <div className="mb-16 animate-in fade-in-0 duration-1000 delay-400">
              <p className="text-xl md:text-2xl xl:text-3xl text-gray-200 max-w-5xl mx-auto leading-relaxed font-light">
                Assemble with the greatest minds in technology and innovation.<br className="hidden md:block" />
        ...
        <div className="relative z-10 container mx-auto px-6">
          ...
          <div className="text-center mb-20 animate-in fade-in-0 slide-in-from-bottom-6 duration-1000">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Experience three days of innovation, learning, and networking with industry leaders
            </p>
          </div>
            ...
            <div className="group relative text-center p-10 rounded-3xl bg-gradient-to-br from-card/80 to-card/60 backdrop-blur-xl border border-border/30 hover:border-primary/50 transition-all duration-700 hover:scale-105 animate-in fade-in-0 slide-in-from-left-8 duration-1000 delay-200">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-6 text-sm text-muted-foreground/80">
                  Three intensive days of workshops, presentations, and networking
                </div>
              </div>
            </div>
